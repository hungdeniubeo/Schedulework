...
const paths = {
  ...
  meat: (
    <>
      <path d="M20.2 5.2c-2.8-3-8-2.7-12.3.1-4.2 2.8-6.2 7.7-3.8 11.3 2.5 3.8 8.7 4.2 13.1 1.2 4.3-2.9 5.5-9.8 3-12.6Z" />
      <path d="M14.4 5.9c1.4-.9 3.2-.6 4 .6s.1 2.8-1.3 3.7-3.2.6-4-.6-.1-2.8 1.3-3.7ZM6.4 14.7c1.9 1.2 4.1 1.4 6.1.4" />
    </>
  ),
  soup: (
    <>
      <path d="M4 11h16c-.5 5-3.3 8-8 8s-7.5-3-8-8ZM8 21h8" />
      <path d="M7.5 8c-1-1.1-.8-2.3.2-3.2M12 8c-1-1.1-.8-2.3.2-3.2M16.5 8c-1-1.1-.8-2.3.2-3.2" />
    </>
  ),
  salad: (
    <>
      <path d="M4 12h16c-.5 5-3.3 8-8 8s-7.5-3-8-8Z" />
      <path d="M12 12c-4-.3-6.3-2.5-7-6.5 4 .3 6.4 2.5 7 6.5Zm0 0c.6-4 3-6.2 7-6.5-.7 4-3 6.2-7 6.5Z" />
    </>
  ),
  chefHat: (
    <>
